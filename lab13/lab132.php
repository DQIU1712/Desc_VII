...
<FORM NAME="formcookie" METHOD="POST" ACTION="lab132.php">
    <BR/>Hola, primera vez que te vemos por nuestro sitio web ¿Como te llama?
    <INPUT TYPE="text" NAME="visitante">
    <INPUT NAME="enviar" value="Gracia por identificarte" TYPE="submit" /><BR/>
</FORM>
<?php
}
?>
