<?php
    ...
    class agenda extends modeloCredencialesBD
    {
        ...
        private $weeks = array();
        private $html_title;
        protected $titulo, $fecha_inicial,$fecha_final, $ubicacion, $detalle, $correo,$rep_dia,$categoria;
        ...
        public function crear_evento($titulo, $fecha_inicial,$fecha_final, $ubicacion, $detalle, $correo,$rep_dia,$categoria){

            $instruccion="CALL sp_agregar_evento( ?, ?, ?, ?, ?, ?, ?, ?)";
            
            $resultado=$this->_db->prepare($instruccion);
            $resultado->bind_param("ssssssis",$titulo, $fecha_inicial,$fecha_final, $ubicacion, $detalle, $correo,$rep_dia,$categoria);
            ...
            if($resultado){
                ...
                echo '<script>alert("No se pudo agregar correctamente")</script>';
            }
            return $resultado;
